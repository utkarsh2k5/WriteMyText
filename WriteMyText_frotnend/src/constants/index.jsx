export const features = [
  {
    ...
    text: "Skip the hassle of writing by hand—instantly transform your typed words into your own handwriting, so you never waste time on repetitive writing again",
    button: {
  ...
  },
  {
    ...
    text: "Your notes stay private and truly yours. Every text you convert remains secure, with your personal handwriting kept safe—so you can express yourself with confidence",
    button: {
...
export const details = [
  {
    ...
    title: "Instantly Generate Handwritten Pages",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Effortless Collaboration on Shared Notes",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Lightning-Fast Text-to-Handwriting Conversion",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Dedicated 24/7 User Assistance",
  },
];
